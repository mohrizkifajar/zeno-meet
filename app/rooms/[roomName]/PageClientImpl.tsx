...
export function PageClientImpl(props: {
  ...
  const handlePreJoinSubmit = React.useCallback(async (values: LocalUserChoices) => {
    ...
    console.info(CONN_DETAILS_ENDPOINT);
    ...
    const connectionDetailsResp = await fetch(url.toString(), {
      ...
      method: 'POST',
      body: JSON.stringify({
        'meeting_id': props.roomName,
        'participant_name': values.username,
      }),
    });
...
function VideoConferenceComponent(props: {
  ...
  React.useEffect(() => {
    ...
    if (e2eeSetupComplete) {
      room
        .connect(
          props.connectionDetails.data.server_url,
          props.connectionDetails.data.participant_token,
          connectOptions,
        )
        .catch((error) => {
          handleError(error);
